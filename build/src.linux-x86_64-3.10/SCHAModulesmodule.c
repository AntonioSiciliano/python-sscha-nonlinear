 ...
 * Generation date: Tue Oct 15 09:52:44 2024
...
/*decl*/
    ...
    PyArrayObject *capi_forces_e_as_array = NULL;
    ...
    PyArrayObject *capi_u_vector_as_array = NULL;
    ...
    PyArrayObject *capi_abinit_stress_tensors_as_array = NULL;
    ...
    const int er_Rank = 3;
    PyArrayObject *capi_er_as_array = NULL;
    ...
    PyArrayObject *capi_stress_tensor_as_array = NULL;
    ...
    PyArrayObject *capi_error_on_stress_tensor_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_stress_tensor: failed to create array from the hidden `stress_tensor`";
    capi_stress_tensor_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,stress_tensor_Dims,stress_tensor_Rank,  capi_stress_tensor_intent,Py_None,capi_errmess);
    if (capi_stress_tensor_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        }
    } else {
        stress_tensor = (double *)(PyArray_DATA(capi_stress_tensor_as_array));
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_stress_tensor: failed to create array from the hidden `error_on_stress_tensor`";
    capi_error_on_stress_tensor_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,error_on_stress_tensor_Dims,error_on_stress_tensor_Rank,  capi_error_on_stress_tensor_intent,Py_None,capi_errmess);
    if (capi_error_on_stress_tensor_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        error_on_stress_tensor = (double *)(PyArray_DATA(capi_error_on_stress_tensor_as_array));

    /* Processing variable wr */
    ;
    capi_wr_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_stress_tensor: failed to create array from the 5th argument `wr`";
    capi_wr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_Dims,wr_Rank,  capi_wr_intent,wr_capi,capi_errmess);
    if (capi_wr_as_array == NULL) {
        ...
        wr = (double *)(PyArray_DATA(capi_wr_as_array));

    /* Processing variable forces_e */
    forces_e_Dims[2]=3;
    capi_forces_e_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_stress_tensor: failed to create array from the 2nd argument `forces_e`";
    capi_forces_e_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,forces_e_Dims,forces_e_Rank,  capi_forces_e_intent,forces_e_capi,capi_errmess);
    if (capi_forces_e_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        forces_e = (double *)(PyArray_DATA(capi_forces_e_as_array));
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_stress_tensor: failed to create array from the 4th argument `abinit_stress_tensors`";
    capi_abinit_stress_tensors_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,abinit_stress_tensors_Dims,abinit_stress_tensors_Rank,  capi_abinit_stress_tensors_intent,abinit_stress_tensors_capi,capi_errmess);
    if (capi_abinit_stress_tensors_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        abinit_stress_tensors = (double *)(PyArray_DATA(capi_abinit_stress_tensors_as_array));

    /* Processing variable rho */
    rho_Dims[0]=nrandom;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_stress_tensor: failed to create array from the 8th argument `rho`";
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_stress_tensor: failed to create array from the 6th argument `er`";
    capi_er_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,er_Dims,er_Rank,  capi_er_intent,er_capi,capi_errmess);
    if (capi_er_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        er = (double *)(PyArray_DATA(capi_er_as_array));
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_stress_tensor: failed to create array from the 3rd argument `u_vector`";
    capi_u_vector_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,u_vector_Dims,u_vector_Rank,  capi_u_vector_intent,u_vector_capi,capi_errmess);
    if (capi_u_vector_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        u_vector = (double *)(PyArray_DATA(capi_u_vector_as_array));
...
/*end of pyobjfrom*/
        ...
        capi_buildvalue = Py_BuildValue("NN",capi_stress_tensor_as_array,capi_error_on_stress_tensor_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    if((PyObject *)capi_u_vector_as_array!=u_vector_capi) {
        Py_XDECREF(capi_u_vector_as_array); }
    }  /* if (capi_u_vector_as_array == NULL) ... else of u_vector */
    /* End of cleaning variable u_vector */
    if((PyObject *)capi_er_as_array!=er_capi) {
        Py_XDECREF(capi_er_as_array); }
    }  /* if (capi_er_as_array == NULL) ... else of er */
    ...
    if((PyObject *)capi_abinit_stress_tensors_as_array!=abinit_stress_tensors_capi) {
        Py_XDECREF(capi_abinit_stress_tensors_as_array); }
    }  /* if (capi_abinit_stress_tensors_as_array == NULL) ... else of abinit_stress_tensors */
    ...
    if((PyObject *)capi_forces_e_as_array!=forces_e_capi) {
        Py_XDECREF(capi_forces_e_as_array); }
    }  /* if (capi_forces_e_as_array == NULL) ... else of forces_e */
    ...
    }  /* if (capi_error_on_stress_tensor_as_array == NULL) ... else of error_on_stress_tensor */
    /* End of cleaning variable error_on_stress_tensor */
    }  /* if (capi_stress_tensor_as_array == NULL) ... else of stress_tensor */
...
/*decl*/
    ...
    PyArrayObject *capi_epols_sc_as_array = NULL;
    ...
    PyArrayObject *capi_ityp_sc_as_array = NULL;
...
/*frompyobj*/
    ...
    ;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the 1st argument `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,rho_capi,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the 4th argument `wr_sc`";
    capi_wr_sc_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_sc_Dims,wr_sc_Rank,  capi_wr_sc_intent,wr_sc_capi,capi_errmess);
    if (capi_wr_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        wr_sc = (double *)(PyArray_DATA(capi_wr_sc_as_array));
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the 8th argument `mass`";
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the 2nd argument `u_disp`";
    capi_u_disp_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,u_disp_Dims,u_disp_Rank,  capi_u_disp_intent,u_disp_capi,capi_errmess);
    if (capi_u_disp_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        u_disp = (double *)(PyArray_DATA(capi_u_disp_as_array));

    /* Processing variable trans */
    trans_Dims[0]=n_modes;
    capi_trans_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the 6th argument `trans`";
    capi_trans_as_array = ndarray_from_pyobj(  NPY_INT,1,trans_Dims,trans_Rank,  capi_trans_intent,trans_capi,capi_errmess);
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the 3rd argument `eforces`";
    capi_eforces_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,eforces_Dims,eforces_Rank,  capi_eforces_intent,eforces_capi,capi_errmess);
    if (capi_eforces_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        eforces = (double *)(PyArray_DATA(capi_eforces_as_array));

    /* Processing variable epols_sc */
    epols_sc_Dims[0]=3 * natsc,epols_sc_Dims[1]=n_modes;
    capi_epols_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the 5th argument `epols_sc`";
    capi_epols_sc_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,epols_sc_Dims,epols_sc_Rank,  capi_epols_sc_intent,epols_sc_capi,capi_errmess);
    if (capi_epols_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        epols_sc = (double *)(PyArray_DATA(capi_epols_sc_as_array));

    /* Processing variable ityp_sc */
    ityp_sc_Dims[0]=natsc;
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the 9th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        ityp_sc = (int *)(PyArray_DATA(capi_ityp_sc_as_array));

    /* Processing variable grad */
    grad_Dims[0]=3 * natsc,grad_Dims[1]=3 * natsc;
    capi_grad_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the hidden `grad`";
    capi_grad_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,grad_Dims,grad_Rank,  capi_grad_intent,Py_None,capi_errmess);
    if (capi_grad_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        grad = (double *)(PyArray_DATA(capi_grad_as_array));
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell: failed to create array from the hidden `grad_err`";
    capi_grad_err_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,grad_err_Dims,grad_err_Rank,  capi_grad_err_intent,Py_None,capi_errmess);
    if (capi_grad_err_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        grad_err = (double *)(PyArray_DATA(capi_grad_err_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("NN",capi_grad_as_array,capi_grad_err_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_grad_err_as_array == NULL) ... else of grad_err */
    /* End of cleaning variable grad_err */
    }  /* if (capi_grad_as_array == NULL) ... else of grad */
    /* End of cleaning variable grad */
    if((PyObject *)capi_ityp_sc_as_array!=ityp_sc_capi) {
        Py_XDECREF(capi_ityp_sc_as_array); }
    }  /* if (capi_ityp_sc_as_array == NULL) ... else of ityp_sc */
    /* End of cleaning variable ityp_sc */
    if((PyObject *)capi_epols_sc_as_array!=epols_sc_capi) {
        Py_XDECREF(capi_epols_sc_as_array); }
    }  /* if (capi_epols_sc_as_array == NULL) ... else of epols_sc */
    /* End of cleaning variable epols_sc */
    if((PyObject *)capi_eforces_as_array!=eforces_capi) {
        Py_XDECREF(capi_eforces_as_array); }
    }  /* if (capi_eforces_as_array == NULL) ... else of eforces */
    /* End of cleaning variable eforces */
    } /*CHECKSCALAR(shape(u_disp, 1) == natsc)*/
    } /*if (f2py_success) of natsc*/
    /* End of cleaning variable natsc */
    if((PyObject *)capi_trans_as_array!=trans_capi) {
        Py_XDECREF(capi_trans_as_array); }
    }  /* if (capi_trans_as_array == NULL) ... else of trans */
    /* End of cleaning variable trans */
    if((PyObject *)capi_u_disp_as_array!=u_disp_capi) {
        Py_XDECREF(capi_u_disp_as_array); }
    }  /* if (capi_u_disp_as_array == NULL) ... else of u_disp */
    ...
    /* End of cleaning variable t */
    if((PyObject *)capi_wr_sc_as_array!=wr_sc_capi) {
        Py_XDECREF(capi_wr_sc_as_array); }
    }  /* if (capi_wr_sc_as_array == NULL) ... else of wr_sc */
...
/*frompyobj*/
    ...
    ;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the 1st argument `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,rho_capi,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_wr_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the 4th argument `wr_sc`";
    capi_wr_sc_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_sc_Dims,wr_sc_Rank,  capi_wr_sc_intent,wr_sc_capi,capi_errmess);
    if (capi_wr_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_mass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the 8th argument `mass`";
    capi_mass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,mass_Dims,mass_Rank,  capi_mass_intent,mass_capi,capi_errmess);
    if (capi_mass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    u_disp_Dims[0]=n_random,u_disp_Dims[2]=3;
    capi_u_disp_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the 2nd argument `u_disp`";
    capi_u_disp_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,u_disp_Dims,u_disp_Rank,  capi_u_disp_intent,u_disp_capi,capi_errmess);
    if (capi_u_disp_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    trans_Dims[0]=n_modes;
    capi_trans_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the 6th argument `trans`";
    capi_trans_as_array = ndarray_from_pyobj(  NPY_INT,1,trans_Dims,trans_Rank,  capi_trans_intent,trans_capi,capi_errmess);
    if (capi_trans_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    eforces_Dims[0]=n_random,eforces_Dims[1]=natsc,eforces_Dims[2]=3;
    capi_eforces_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the 3rd argument `eforces`";
    capi_eforces_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,eforces_Dims,eforces_Rank,  capi_eforces_intent,eforces_capi,capi_errmess);
    if (capi_eforces_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    epols_sc_Dims[0]=3 * natsc,epols_sc_Dims[1]=n_modes;
    capi_epols_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the 5th argument `epols_sc`";
    capi_epols_sc_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,epols_sc_Dims,epols_sc_Rank,  capi_epols_sc_intent,epols_sc_capi,capi_errmess);
    if (capi_epols_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ityp_sc_Dims[0]=natsc;
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the 9th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    grad_Dims[0]=3 * natsc,grad_Dims[1]=3 * natsc;
    capi_grad_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the hidden `grad`";
    capi_grad_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,grad_Dims,grad_Rank,  capi_grad_intent,Py_None,capi_errmess);
    if (capi_grad_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    grad_err_Dims[0]=3 * natsc,grad_err_Dims[1]=3 * natsc;
    capi_grad_err_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_new: failed to create array from the hidden `grad_err`";
    capi_grad_err_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,grad_err_Dims,grad_err_Rank,  capi_grad_err_intent,Py_None,capi_errmess);
    if (capi_grad_err_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*decl*/
    ...
    PyArrayObject *capi_epols_as_array = NULL;
    ...
    PyArrayObject *capi_ups_as_array = NULL;
...
/*frompyobj*/
    ...
    ;
    capi_wr_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_upsilon_matrix: failed to create array from the 1st argument `wr`";
    capi_wr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_Dims,wr_Rank,  capi_wr_intent,wr_capi,capi_errmess);
    if (capi_wr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_mass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_upsilon_matrix: failed to create array from the 4th argument `mass`";
    capi_mass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,mass_Dims,mass_Rank,  capi_mass_intent,mass_capi,capi_errmess);
    if (capi_mass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_upsilon_matrix: failed to create array from the 2nd argument `epols`";
    capi_epols_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,epols_Dims,epols_Rank,  capi_epols_intent,epols_capi,capi_errmess);
    if (capi_epols_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        epols = (double *)(PyArray_DATA(capi_epols_as_array));

    /* Processing variable trans */
    trans_Dims[0]=nmodes;
    capi_trans_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_upsilon_matrix: failed to create array from the 3rd argument `trans`";
    capi_trans_as_array = ndarray_from_pyobj(  NPY_INT,1,trans_Dims,trans_Rank,  capi_trans_intent,trans_capi,capi_errmess);
    if (capi_trans_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_upsilon_matrix: failed to create array from the 5th argument `ityp`";
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_upsilon_matrix: failed to create array from the hidden `ups`";
    capi_ups_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,ups_Dims,ups_Rank,  capi_ups_intent,Py_None,capi_errmess);
    if (capi_ups_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        ups = (double *)(PyArray_DATA(capi_ups_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_ups_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_ups_as_array == NULL) ... else of ups */
    ...
    /* End of cleaning variable trans */
    if((PyObject *)capi_epols_as_array!=epols_capi) {
        Py_XDECREF(capi_epols_as_array); }
    }  /* if (capi_epols_as_array == NULL) ... else of epols */
...
/*decl*/
    ...
    PyArrayObject *capi_input_matrix_as_array = NULL;
    ...
    PyArrayObject *capi_output_matrix_as_array = NULL;
...
/*frompyobj*/
    ...
    ;
    capi_wr_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.multiply_lambda_tensor: failed to create array from the 1st argument `wr`";
    capi_wr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_Dims,wr_Rank,  capi_wr_intent,wr_capi,capi_errmess);
    if (capi_wr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_mass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.multiply_lambda_tensor: failed to create array from the 4th argument `mass`";
    capi_mass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,mass_Dims,mass_Rank,  capi_mass_intent,mass_capi,capi_errmess);
    if (capi_mass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.multiply_lambda_tensor: failed to create array from the 2nd argument `pols`";
    ...
    trans_Dims[0]=nmodes;
    capi_trans_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.multiply_lambda_tensor: failed to create array from the 3rd argument `trans`";
    capi_trans_as_array = ndarray_from_pyobj(  NPY_INT,1,trans_Dims,trans_Rank,  capi_trans_intent,trans_capi,capi_errmess);
    if (capi_trans_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ityp_Dims[0]=nat;
    capi_ityp_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.multiply_lambda_tensor: failed to create array from the 5th argument `ityp`";
    capi_ityp_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_Dims,ityp_Rank,  capi_ityp_intent,ityp_capi,capi_errmess);
    if (capi_ityp_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.multiply_lambda_tensor: failed to create array from the 7th argument `input_matrix`";
    capi_input_matrix_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,input_matrix_Dims,input_matrix_Rank,  capi_input_matrix_intent,input_matrix_capi,capi_errmess);
    if (capi_input_matrix_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        input_matrix = (double *)(PyArray_DATA(capi_input_matrix_as_array));
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.multiply_lambda_tensor: failed to create array from the hidden `output_matrix`";
    capi_output_matrix_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,output_matrix_Dims,output_matrix_Rank,  capi_output_matrix_intent,Py_None,capi_errmess);
    if (capi_output_matrix_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        output_matrix = (double *)(PyArray_DATA(capi_output_matrix_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_output_matrix_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_output_matrix_as_array == NULL) ... else of output_matrix */
    /* End of cleaning variable output_matrix */
    if((PyObject *)capi_input_matrix_as_array!=input_matrix_capi) {
        Py_XDECREF(capi_input_matrix_as_array); }
    }  /* if (capi_input_matrix_as_array == NULL) ... else of input_matrix */
...
/*decl*/
    ...
    PyArrayObject *capi_fcell_as_array = NULL;
    ...
    PyArrayObject *capi_stress_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.cell_force: failed to create array from the hidden `fcell`";
    capi_fcell_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,fcell_Dims,fcell_Rank,  capi_fcell_intent,Py_None,capi_errmess);
    if (capi_fcell_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        fcell = (double *)(PyArray_DATA(capi_fcell_as_array));

    /* Processing variable stress */
    stress_Dims[0]=3,stress_Dims[1]=3;
    capi_stress_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.cell_force: failed to create array from the 2nd argument `stress`";
    capi_stress_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,stress_Dims,stress_Rank,  capi_stress_intent,stress_capi,capi_errmess);
    if (capi_stress_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        stress = (double *)(PyArray_DATA(capi_stress_as_array));

    /* Processing variable ainv */
    ainv_Dims[0]=3,ainv_Dims[1]=3;
    capi_ainv_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.cell_force: failed to create array from the 1st argument `ainv`";
    capi_ainv_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,ainv_Dims,ainv_Rank,  capi_ainv_intent,ainv_capi,capi_errmess);
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_fcell_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    ...
    if((PyObject *)capi_ainv_as_array!=ainv_capi) {
        Py_XDECREF(capi_ainv_as_array); }
    }  /* if (capi_ainv_as_array == NULL) ... else of ainv */
    /* End of cleaning variable ainv */
    if((PyObject *)capi_stress_as_array!=stress_capi) {
        Py_XDECREF(capi_stress_as_array); }
    }  /* if (capi_stress_as_array == NULL) ... else of stress */
    /* End of cleaning variable stress */
    }  /* if (capi_fcell_as_array == NULL) ... else of fcell */
...
/*frompyobj*/
    ...
    ;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the 1st argument `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,rho_capi,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_wr_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the 4th argument `wr_sc`";
    capi_wr_sc_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_sc_Dims,wr_sc_Rank,  capi_wr_sc_intent,wr_sc_capi,capi_errmess);
    if (capi_wr_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_mass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the 8th argument `mass`";
    capi_mass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,mass_Dims,mass_Rank,  capi_mass_intent,mass_capi,capi_errmess);
    if (capi_mass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    u_disp_Dims[0]=n_random,u_disp_Dims[2]=3;
    capi_u_disp_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the 2nd argument `u_disp`";
    capi_u_disp_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,u_disp_Dims,u_disp_Rank,  capi_u_disp_intent,u_disp_capi,capi_errmess);
    if (capi_u_disp_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    trans_Dims[0]=n_modes;
    capi_trans_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the 6th argument `trans`";
    capi_trans_as_array = ndarray_from_pyobj(  NPY_INT,1,trans_Dims,trans_Rank,  capi_trans_intent,trans_capi,capi_errmess);
    if (capi_trans_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    eforces_Dims[0]=n_random,eforces_Dims[1]=natsc,eforces_Dims[2]=3;
    capi_eforces_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the 3rd argument `eforces`";
    capi_eforces_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,eforces_Dims,eforces_Rank,  capi_eforces_intent,eforces_capi,capi_errmess);
    if (capi_eforces_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    epols_sc_Dims[0]=3 * natsc,epols_sc_Dims[1]=n_modes;
    capi_epols_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the 5th argument `epols_sc`";
    capi_epols_sc_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,epols_sc_Dims,epols_sc_Rank,  capi_epols_sc_intent,epols_sc_capi,capi_errmess);
    if (capi_epols_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ityp_sc_Dims[0]=natsc;
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the 9th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    grad_Dims[0]=3 * natsc,grad_Dims[1]=3 * natsc;
    capi_grad_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the hidden `grad`";
    capi_grad_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,grad_Dims,grad_Rank,  capi_grad_intent,Py_None,capi_errmess);
    if (capi_grad_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    grad_err_Dims[0]=3 * natsc,grad_err_Dims[1]=3 * natsc;
    capi_grad_err_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_gradient_supercell_fast: failed to create array from the hidden `grad_err`";
    capi_grad_err_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,grad_err_Dims,grad_err_Rank,  capi_grad_err_intent,Py_None,capi_errmess);
    if (capi_grad_err_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*decl*/
    ...
    PyArrayObject *capi_e_pols_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the 1st argument `u`";
    ...
    ;
    capi_mass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the 6th argument `mass`";
    capi_mass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,mass_Dims,mass_Rank,  capi_mass_intent,mass_capi,capi_errmess);
    if (capi_mass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the 2nd argument `f`";
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the 3rd argument `e_pols`";
    capi_e_pols_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,e_pols_Dims,e_pols_Rank,  capi_e_pols_intent,e_pols_capi,capi_errmess);
    if (capi_e_pols_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        e_pols = (double *)(PyArray_DATA(capi_e_pols_as_array));

    /* Processing variable ityp */
    ityp_Dims[0]=n / 3;
    capi_ityp_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the 7th argument `ityp`";
    capi_ityp_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_Dims,ityp_Rank,  capi_ityp_intent,ityp_capi,capi_errmess);
    if (capi_ityp_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    rho_Dims[0]=nrand;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the 8th argument `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,rho_capi,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the hidden `gradient`";
    capi_gradient_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,gradient_Dims,gradient_Rank,  capi_gradient_intent,Py_None,capi_errmess);
    if (capi_gradient_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        gradient = (double *)(PyArray_DATA(capi_gradient_as_array));
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the hidden `err_gradient`";
    capi_err_gradient_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,err_gradient_Dims,err_gradient_Rank,  capi_err_gradient_intent,Py_None,capi_errmess);
    if (capi_err_gradient_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        err_gradient = (double *)(PyArray_DATA(capi_err_gradient_as_array));
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_unpreconditioned_gradient: failed to create array from the 4th argument `w`";
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("NN",capi_gradient_as_array,capi_err_gradient_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    ...
    /* End of cleaning variable nmodes */
    }  /* if (capi_err_gradient_as_array == NULL) ... else of err_gradient */
    /* End of cleaning variable err_gradient */
    }  /* if (capi_gradient_as_array == NULL) ... else of gradient */
    ...
    /* End of cleaning variable ityp */
    if((PyObject *)capi_e_pols_as_array!=e_pols_capi) {
        Py_XDECREF(capi_e_pols_as_array); }
    }  /* if (capi_e_pols_as_array == NULL) ... else of e_pols */
...
/*decl*/
    ...
    PyArrayObject *capi_transmode_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_g: failed to create array from the 1st argument `a`";
    ...
    wr_Dims[0]=n_mode;
    capi_wr_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_g: failed to create array from the 2nd argument `wr`";
    capi_wr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_Dims,wr_Rank,  capi_wr_intent,wr_capi,capi_errmess);
    if (capi_wr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_g: failed to create array from the 3rd argument `transmode`";
    capi_transmode_as_array = ndarray_from_pyobj(  NPY_INT,1,transmode_Dims,transmode_Rank,  capi_transmode_intent,transmode_capi,capi_errmess);
    if (capi_transmode_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        transmode = (int *)(PyArray_DATA(capi_transmode_as_array));

    /* Processing variable g */
    g_Dims[0]=n_mode,g_Dims[1]=n_mode;
    capi_g_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_g: failed to create array from the hidden `g`";
    capi_g_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,g_Dims,g_Rank,  capi_g_intent,Py_None,capi_errmess);
...
/*cleanupfrompyobj*/
    ...
    if((PyObject *)capi_transmode_as_array!=transmode_capi) {
        Py_XDECREF(capi_transmode_as_array); }
    }  /* if (capi_transmode_as_array == NULL) ... else of transmode */
...
/*decl*/
    ...
    PyArrayObject *capi_amass_as_array = NULL;
...
/*frompyobj*/
    ...
    er_Dims[2]=3;
    capi_er_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_emat: failed to create array from the 1st argument `er`";
    capi_er_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,er_Dims,er_Rank,  capi_er_intent,er_capi,capi_errmess);
    if (capi_er_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_emat: failed to create array from the 3rd argument `amass`";
    capi_amass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,amass_Dims,amass_Rank,  capi_amass_intent,amass_capi,capi_errmess);
    if (capi_amass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        amass = (double *)(PyArray_DATA(capi_amass_as_array));
    ...
    a_Dims[0]=n_mode;
    capi_a_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_emat: failed to create array from the 2nd argument `a`";
    capi_a_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_Dims,a_Rank,  capi_a_intent,a_capi,capi_errmess);
    if (capi_a_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_emat: failed to create array from the 4th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    transmode_Dims[0]=n_mode;
    capi_transmode_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_emat: failed to create array from the 6th argument `transmode`";
    capi_transmode_as_array = ndarray_from_pyobj(  NPY_INT,1,transmode_Dims,transmode_Rank,  capi_transmode_intent,transmode_capi,capi_errmess);
    if (capi_transmode_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_emat: failed to create array from the hidden `e`";
    capi_e_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,e_Dims,e_Rank,  capi_e_intent,Py_None,capi_errmess);
...
/*cleanupfrompyobj*/
    ...
    if((PyObject *)capi_amass_as_array!=amass_capi) {
        Py_XDECREF(capi_amass_as_array); }
    }  /* if (capi_amass_as_array == NULL) ... else of amass */
...
/*frompyobj*/
    ...
    ;
    capi_a_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the 1st argument `a`";
    capi_a_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_Dims,a_Rank,  capi_a_intent,a_capi,capi_errmess);
    if (capi_a_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_amass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the 4th argument `amass`";
    capi_amass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,amass_Dims,amass_Rank,  capi_amass_intent,amass_capi,capi_errmess);
    if (capi_amass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    capi_er_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the 2nd argument `er`";
    capi_er_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,er_Dims,er_Rank,  capi_er_intent,er_capi,capi_errmess);
    if (capi_er_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    transmode_Dims[0]=n_mode;
    capi_transmode_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the 3rd argument `transmode`";
    capi_transmode_as_array = ndarray_from_pyobj(  NPY_INT,1,transmode_Dims,transmode_Rank,  capi_transmode_intent,transmode_capi,capi_errmess);
    if (capi_transmode_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the hidden `v3`";
    capi_v3_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,v3_Dims,v3_Rank,  capi_v3_intent,Py_None,capi_errmess);
    ...
    ityp_sc_Dims[0]=nat_sc;
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the 5th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    capi_f_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the 6th argument `f`";
    capi_f_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,f_Dims,f_Rank,  capi_f_intent,f_capi,capi_errmess);
    if (capi_f_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    capi_u_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the 7th argument `u`";
    capi_u_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,u_Dims,u_Rank,  capi_u_intent,u_capi,capi_errmess);
    if (capi_u_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    rho_Dims[0]=n_random;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v3: failed to create array from the 8th argument `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,rho_capi,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_v3_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
...
/*decl*/
    ...
    PyArrayObject *capi_phi_sc_odd_as_array = NULL;
...
/*frompyobj*/
    ...
    ;
    capi_a_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight: failed to create array from the 1st argument `a`";
    capi_a_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_Dims,a_Rank,  capi_a_intent,a_capi,capi_errmess);
    if (capi_a_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_amass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight: failed to create array from the 5th argument `amass`";
    capi_amass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,amass_Dims,amass_Rank,  capi_amass_intent,amass_capi,capi_errmess);
    if (capi_amass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    wr_Dims[0]=n_mode;
    capi_wr_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight: failed to create array from the 2nd argument `wr`";
    capi_wr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_Dims,wr_Rank,  capi_wr_intent,wr_capi,capi_errmess);
    if (capi_wr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    er_Dims[1]=n_mode,er_Dims[2]=3;
    capi_er_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight: failed to create array from the 3rd argument `er`";
    capi_er_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,er_Dims,er_Rank,  capi_er_intent,er_capi,capi_errmess);
    if (capi_er_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    transmode_Dims[0]=n_mode;
    capi_transmode_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight: failed to create array from the 4th argument `transmode`";
    capi_transmode_as_array = ndarray_from_pyobj(  NPY_INT,1,transmode_Dims,transmode_Rank,  capi_transmode_intent,transmode_capi,capi_errmess);
    if (capi_transmode_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight: failed to create array from the 8th argument `v3`";
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight: failed to create array from the hidden `phi_sc_odd`";
    capi_phi_sc_odd_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,phi_sc_odd_Dims,phi_sc_odd_Rank,  capi_phi_sc_odd_intent,Py_None,capi_errmess);
    if (capi_phi_sc_odd_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        phi_sc_odd = (double *)(PyArray_DATA(capi_phi_sc_odd_as_array));
    ...
    ityp_sc_Dims[0]=nat_sc;
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight: failed to create array from the 6th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_phi_sc_odd_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    ...
    /* End of cleaning variable nat_sc */
    }  /* if (capi_phi_sc_odd_as_array == NULL) ... else of phi_sc_odd */
...
/*decl*/
    ...
    PyArrayObject *capi_cmat_as_array = NULL;
...
/*frompyobj*/
    ...
    ;
    capi_a_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_cmat: failed to create array from the 1st argument `a`";
    capi_a_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_Dims,a_Rank,  capi_a_intent,a_capi,capi_errmess);
    if (capi_a_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_amass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_cmat: failed to create array from the 5th argument `amass`";
    capi_amass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,amass_Dims,amass_Rank,  capi_amass_intent,amass_capi,capi_errmess);
    if (capi_amass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    wr_Dims[0]=n_mode;
    capi_wr_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_cmat: failed to create array from the 2nd argument `wr`";
    capi_wr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_Dims,wr_Rank,  capi_wr_intent,wr_capi,capi_errmess);
    if (capi_wr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    er_Dims[1]=n_mode,er_Dims[2]=3;
    capi_er_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_cmat: failed to create array from the 3rd argument `er`";
    capi_er_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,er_Dims,er_Rank,  capi_er_intent,er_capi,capi_errmess);
    if (capi_er_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    transmode_Dims[0]=n_mode;
    capi_transmode_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_cmat: failed to create array from the 4th argument `transmode`";
    capi_transmode_as_array = ndarray_from_pyobj(  NPY_INT,1,transmode_Dims,transmode_Rank,  capi_transmode_intent,transmode_capi,capi_errmess);
    if (capi_transmode_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_cmat: failed to create array from the hidden `cmat`";
    capi_cmat_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,cmat_Dims,cmat_Rank,  capi_cmat_intent,Py_None,capi_errmess);
    if (capi_cmat_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        cmat = (double *)(PyArray_DATA(capi_cmat_as_array));
    ...
    ityp_sc_Dims[0]=nat_sc;
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_cmat: failed to create array from the 6th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_cmat_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    ...
    /* End of cleaning variable nat_sc */
    }  /* if (capi_cmat_as_array == NULL) ... else of cmat */
...
/*frompyobj*/
    ...
    ;
    capi_a_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the 1st argument `a`";
    capi_a_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_Dims,a_Rank,  capi_a_intent,a_capi,capi_errmess);
    if (capi_a_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_amass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the 4th argument `amass`";
    capi_amass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,amass_Dims,amass_Rank,  capi_amass_intent,amass_capi,capi_errmess);
    if (capi_amass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    er_Dims[1]=n_mode,er_Dims[2]=3;
    capi_er_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the 2nd argument `er`";
    capi_er_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,er_Dims,er_Rank,  capi_er_intent,er_capi,capi_errmess);
    if (capi_er_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    transmode_Dims[0]=n_mode;
    capi_transmode_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the 3rd argument `transmode`";
    capi_transmode_as_array = ndarray_from_pyobj(  NPY_INT,1,transmode_Dims,transmode_Rank,  capi_transmode_intent,transmode_capi,capi_errmess);
    if (capi_transmode_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the hidden `v4`";
    capi_v4_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,v4_Dims,v4_Rank,  capi_v4_intent,Py_None,capi_errmess);
    ...
    ityp_sc_Dims[0]=nat_sc;
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the 5th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    f_Dims[1]=nat_sc,f_Dims[2]=3;
    capi_f_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the 6th argument `f`";
    capi_f_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,f_Dims,f_Rank,  capi_f_intent,f_capi,capi_errmess);
    if (capi_f_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    u_Dims[0]=n_random,u_Dims[1]=nat_sc,u_Dims[2]=3;
    capi_u_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the 7th argument `u`";
    capi_u_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,u_Dims,u_Rank,  capi_u_intent,u_capi,capi_errmess);
    if (capi_u_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    rho_Dims[0]=n_random;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_v4: failed to create array from the 8th argument `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,rho_capi,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_v4_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
...
/*frompyobj*/
    ...
    ;
    capi_a_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the 1st argument `a`";
    capi_a_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_Dims,a_Rank,  capi_a_intent,a_capi,capi_errmess);
    if (capi_a_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_amass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the 5th argument `amass`";
    capi_amass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,amass_Dims,amass_Rank,  capi_amass_intent,amass_capi,capi_errmess);
    if (capi_amass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    wr_Dims[0]=n_mode;
    capi_wr_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the 2nd argument `wr`";
    capi_wr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_Dims,wr_Rank,  capi_wr_intent,wr_capi,capi_errmess);
    if (capi_wr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    er_Dims[1]=n_mode,er_Dims[2]=3;
    capi_er_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the 3rd argument `er`";
    capi_er_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,er_Dims,er_Rank,  capi_er_intent,er_capi,capi_errmess);
    if (capi_er_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    transmode_Dims[0]=n_mode;
    capi_transmode_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the 4th argument `transmode`";
    capi_transmode_as_array = ndarray_from_pyobj(  NPY_INT,1,transmode_Dims,transmode_Rank,  capi_transmode_intent,transmode_capi,capi_errmess);
    if (capi_transmode_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    v3_Dims[0]=n_mode,v3_Dims[1]=n_mode,v3_Dims[2]=n_mode;
    capi_v3_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the 8th argument `v3`";
    capi_v3_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,v3_Dims,v3_Rank,  capi_v3_intent,v3_capi,capi_errmess);
    if (capi_v3_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the 9th argument `v4`";
    ...
    phi_sc_odd_Dims[0]=n_mode,phi_sc_odd_Dims[1]=n_mode;
    capi_phi_sc_odd_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the hidden `phi_sc_odd`";
    capi_phi_sc_odd_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,phi_sc_odd_Dims,phi_sc_odd_Rank,  capi_phi_sc_odd_intent,Py_None,capi_errmess);
    if (capi_phi_sc_odd_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ityp_sc_Dims[0]=nat_sc;
    capi_ityp_sc_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.get_odd_straight_with_v4: failed to create array from the 6th argument `ityp_sc`";
    capi_ityp_sc_as_array = ndarray_from_pyobj(  NPY_INT,1,ityp_sc_Dims,ityp_sc_Rank,  capi_ityp_sc_intent,ityp_sc_capi,capi_errmess);
    if (capi_ityp_sc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*decl*/
    ...
    PyArrayObject *capi_random_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.check_gaussian: failed to create array from the 1st argument `random`";
    capi_random_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,random_Dims,random_Rank,  capi_random_intent,random_capi,capi_errmess);
    if (capi_random_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        random = (double *)(PyArray_DATA(capi_random_as_array));
...
/*cleanupfrompyobj*/
    ...
    if((PyObject *)capi_random_as_array!=random_capi) {
        Py_XDECREF(capi_random_as_array); }
    }  /* if (capi_random_as_array == NULL) ... else of random */
...
/*decl*/
    ...
    PyArrayObject *capi_q_start_as_array = NULL;
    ...
    PyArrayObject *capi_a_start_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight: failed to create array from the 1st argument `q`";
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight: failed to create array from the 2nd argument `q_start`";
    capi_q_start_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,q_start_Dims,q_start_Rank,  capi_q_start_intent,q_start_capi,capi_errmess);
    if (capi_q_start_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        q_start = (double *)(PyArray_DATA(capi_q_start_as_array));

    /* Processing variable a_start */
    a_start_Dims[0]=n_modes;
    capi_a_start_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight: failed to create array from the 4th argument `a_start`";
    capi_a_start_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_start_Dims,a_start_Rank,  capi_a_start_intent,a_start_capi,capi_errmess);
    if (capi_a_start_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        a_start = (double *)(PyArray_DATA(capi_a_start_as_array));

    /* Processing variable a */
    a_Dims[0]=n_modes;
    capi_a_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight: failed to create array from the 3rd argument `a`";
    capi_a_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_Dims,a_Rank,  capi_a_intent,a_capi,capi_errmess);
    if (capi_a_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight: failed to create array from the hidden `rho`";
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_rho_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    ...
    /* End of cleaning variable a */
    if((PyObject *)capi_a_start_as_array!=a_start_capi) {
        Py_XDECREF(capi_a_start_as_array); }
    }  /* if (capi_a_start_as_array == NULL) ... else of a_start */
    /* End of cleaning variable a_start */
    if((PyObject *)capi_q_start_as_array!=q_start_capi) {
        Py_XDECREF(capi_q_start_as_array); }
    }  /* if (capi_q_start_as_array == NULL) ... else of q_start */
...
/*decl*/
    ...
    PyArrayObject *capi_mu_relevant_as_array = NULL;
...
/*frompyobj*/
    ...
    ;
    capi_q_start_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight_eff_charge: failed to create array from the 2nd argument `q_start`";
    capi_q_start_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,q_start_Dims,q_start_Rank,  capi_q_start_intent,q_start_capi,capi_errmess);
    if (capi_q_start_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_q_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight_eff_charge: failed to create array from the 1st argument `q`";
    capi_q_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,q_Dims,q_Rank,  capi_q_intent,q_capi,capi_errmess);
    if (capi_q_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_a_start_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight_eff_charge: failed to create array from the 4th argument `a_start`";
    capi_a_start_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_start_Dims,a_start_Rank,  capi_a_start_intent,a_start_capi,capi_errmess);
    if (capi_a_start_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_a_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight_eff_charge: failed to create array from the 3rd argument `a`";
    capi_a_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,a_Dims,a_Rank,  capi_a_intent,a_capi,capi_errmess);
    if (capi_a_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight_eff_charge: failed to create array from the 5th argument `mu_relevant`";
    capi_mu_relevant_as_array = ndarray_from_pyobj(  NPY_INT,1,mu_relevant_Dims,mu_relevant_Rank,  capi_mu_relevant_intent,mu_relevant_capi,capi_errmess);
    if (capi_mu_relevant_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        mu_relevant = (int *)(PyArray_DATA(capi_mu_relevant_as_array));

    /* Processing variable rho */
    ;
    capi_rho_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.get_gaussian_weight_eff_charge: failed to create array from the hidden `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,Py_None,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*cleanupfrompyobj*/
    ...
    /* End of cleaning variable rho */
    if((PyObject *)capi_mu_relevant_as_array!=mu_relevant_capi) {
        Py_XDECREF(capi_mu_relevant_as_array); }
    }  /* if (capi_mu_relevant_as_array == NULL) ... else of mu_relevant */
...
/*frompyobj*/
    ...
    ;
    capi_f_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.average_error_weight: failed to create array from the 1st argument `f`";
    capi_f_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,f_Dims,f_Rank,  capi_f_intent,f_capi,capi_errmess);
    if (capi_f_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    ;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.average_error_weight: failed to create array from the 2nd argument `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,rho_capi,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
...
/*decl*/
    ...
    PyArrayObject *capi_v_rand_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.stochastic.random_sphere: failed to create array from the hidden `v_rand`";
    capi_v_rand_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,v_rand_Dims,v_rand_Rank,  capi_v_rand_intent,Py_None,capi_errmess);
    if (capi_v_rand_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        v_rand = (double *)(PyArray_DATA(capi_v_rand_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_v_rand_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_v_rand_as_array == NULL) ... else of v_rand */
...
/*frompyobj*/
    ...
    ;
    capi_w_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.thermodynamic.w_to_a: failed to create array from the 1st argument `w`";
    capi_w_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,w_Dims,w_Rank,  capi_w_intent,w_capi,capi_errmess);
    if (capi_w_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.thermodynamic.w_to_a: failed to create array from the hidden `a`";
...
/*frompyobj*/
    ...
    ;
    capi_w_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.thermodynamic.w_to_da: failed to create array from the 1st argument `w`";
    capi_w_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,w_Dims,w_Rank,  capi_w_intent,w_capi,capi_errmess);
    if (capi_w_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.thermodynamic.w_to_da: failed to create array from the hidden `da`";
    capi_da_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,da_Dims,da_Rank,  capi_da_intent,Py_None,capi_errmess);
    if (capi_da_as_array == NULL) {
        ...
        da = (double *)(PyArray_DATA(capi_da_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_da_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
...
/*frompyobj*/
    ...
    if (f2py_success) {
    /* Processing variable dw_f0_u0f2pywrap */
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
    (*f2py_func)(&dw_f0_u0f2pywrap,&w,&t);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("d",dw_f0_u0f2pywrap);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    /* End of cleaning variable dw_f0_u0f2pywrap */
    } /*if (f2py_success) of t*/
    /* End of cleaning variable t */
    } /*if (f2py_success) of w*/
    /* End of cleaning variable w */
...
/*frompyobj*/
    ...
    if (f2py_success) {
    /* Processing variable nbf2pywrap */
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
    (*f2py_func)(&nbf2pywrap,&w,&t);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("d",nbf2pywrap);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    /* End of cleaning variable nbf2pywrap */
    } /*if (f2py_success) of t*/
    /* End of cleaning variable t */
    } /*if (f2py_success) of w*/
    /* End of cleaning variable w */
...
/*decl*/
    ...
    PyArrayObject *capi_w_harmonic_as_array = NULL;
    ...
    PyArrayObject *capi_forces_as_array = NULL;
    ...
    PyArrayObject *capi_df_da_as_array = NULL;
...
/*frompyobj*/
    ...
    ;
    capi_w_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_da_nonav: failed to create array from the 1st argument `w`";
    capi_w_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,w_Dims,w_Rank,  capi_w_intent,w_capi,capi_errmess);
    if (capi_w_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_da_nonav: failed to create array from the 2nd argument `w_harmonic`";
    capi_w_harmonic_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,w_harmonic_Dims,w_harmonic_Rank,  capi_w_harmonic_intent,w_harmonic_capi,capi_errmess);
    if (capi_w_harmonic_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        w_harmonic = (double *)(PyArray_DATA(capi_w_harmonic_as_array));

    /* Processing variable e */
    e_Dims[1]=n;
    capi_e_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_da_nonav: failed to create array from the 4th argument `e`";
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_da_nonav: failed to create array from the 5th argument `forces`";
    capi_forces_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,forces_Dims,forces_Rank,  capi_forces_intent,forces_capi,capi_errmess);
    if (capi_forces_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        forces = (double *)(PyArray_DATA(capi_forces_as_array));

    /* Processing variable mass */
    mass_Dims[0]=m;
    capi_mass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_da_nonav: failed to create array from the 7th argument `mass`";
    capi_mass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,mass_Dims,mass_Rank,  capi_mass_intent,mass_capi,capi_errmess);
    if (capi_mass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    capi_q_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_da_nonav: failed to create array from the 6th argument `q`";
    capi_q_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,q_Dims,q_Rank,  capi_q_intent,q_capi,capi_errmess);
    if (capi_q_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_da_nonav: failed to create array from the hidden `df_da`";
    capi_df_da_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,df_da_Dims,df_da_Rank,  capi_df_da_intent,Py_None,capi_errmess);
    if (capi_df_da_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        df_da = (double *)(PyArray_DATA(capi_df_da_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_df_da_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_df_da_as_array == NULL) ... else of df_da */
    ...
    /* End of cleaning variable mass */
    if((PyObject *)capi_forces_as_array!=forces_capi) {
        Py_XDECREF(capi_forces_as_array); }
    }  /* if (capi_forces_as_array == NULL) ... else of forces */
    ...
    /* End of cleaning variable e */
    if((PyObject *)capi_w_harmonic_as_array!=w_harmonic_capi) {
        Py_XDECREF(capi_w_harmonic_as_array); }
    }  /* if (capi_w_harmonic_as_array == NULL) ... else of w_harmonic */
...
/*decl*/
    ...
    PyArrayObject *capi_da_dcr_as_array = NULL;
    int capi_da_dcr_intent = 0;
    double *de_dcr = NULL;
    npy_intp de_dcr_Dims[2] = {-1, -1};
    const int de_dcr_Rank = 2;
    PyArrayObject *capi_de_dcr_as_array = NULL;
...
/*frompyobj*/
    ...
    ;
    capi_wr_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_da_dcr_and_de_dcr: failed to create array from the 1st argument `wr`";
    capi_wr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,wr_Dims,wr_Rank,  capi_wr_intent,wr_capi,capi_errmess);
    if (capi_wr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    er_Dims[1]=n;
    capi_er_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_da_dcr_and_de_dcr: failed to create array from the 2nd argument `er`";
    capi_er_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,er_Dims,er_Rank,  capi_er_intent,er_capi,capi_errmess);
    if (capi_er_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_da_dcr_and_de_dcr: failed to create array from the hidden `da_dcr`";
    capi_da_dcr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,da_dcr_Dims,da_dcr_Rank,  capi_da_dcr_intent,Py_None,capi_errmess);
    if (capi_da_dcr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        da_dcr = (double *)(PyArray_DATA(capi_da_dcr_as_array));
    ...
    mass_Dims[0]=m;
    capi_mass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_da_dcr_and_de_dcr: failed to create array from the 4th argument `mass`";
    capi_mass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,mass_Dims,mass_Rank,  capi_mass_intent,mass_capi,capi_errmess);
    if (capi_mass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_da_dcr_and_de_dcr: failed to create array from the hidden `de_dcr`";
    capi_de_dcr_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,de_dcr_Dims,de_dcr_Rank,  capi_de_dcr_intent,Py_None,capi_errmess);
    if (capi_de_dcr_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        de_dcr = (double *)(PyArray_DATA(capi_de_dcr_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("NN",capi_da_dcr_as_array,capi_de_dcr_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_de_dcr_as_array == NULL) ... else of de_dcr */
    ...
    /* End of cleaning variable m */
    }  /* if (capi_da_dcr_as_array == NULL) ... else of da_dcr */
...
/*decl*/
    ...
    const int df_Rank = 2;
    PyArrayObject *capi_df_as_array = NULL;
    ...
    PyArrayObject *capi_dedc_as_array = NULL;
...
/*frompyobj*/
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_dcoeff_av_new: failed to create array from the 1st argument `df`";
    capi_df_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,df_Dims,df_Rank,  capi_df_intent,df_capi,capi_errmess);
    if (capi_df_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        df = (double *)(PyArray_DATA(capi_df_as_array));
    ...
    capi_q_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_dcoeff_av_new: failed to create array from the 4th argument `q`";
    capi_q_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,q_Dims,q_Rank,  capi_q_intent,q_capi,capi_errmess);
    if (capi_q_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_dcoeff_av_new: failed to create array from the 2nd argument `da`";
    capi_da_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,da_Dims,da_Rank,  capi_da_intent,da_capi,capi_errmess);
    if (capi_da_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
    ...
    capi_forces_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_dcoeff_av_new: failed to create array from the 3rd argument `forces`";
    capi_forces_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,forces_Dims,forces_Rank,  capi_forces_intent,forces_capi,capi_errmess);
    if (capi_forces_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    rho_Dims[0]=r;
    capi_rho_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_dcoeff_av_new: failed to create array from the 7th argument `rho`";
    capi_rho_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rho_Dims,rho_Rank,  capi_rho_intent,rho_capi,capi_errmess);
    if (capi_rho_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    mass_Dims[0]=t;
    capi_mass_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_dcoeff_av_new: failed to create array from the 5th argument `mass`";
    capi_mass_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,mass_Dims,mass_Rank,  capi_mass_intent,mass_capi,capi_errmess);
    if (capi_mass_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
    ...
    const char * capi_errmess = "SCHAModules.SCHAModules.anharmonic.get_df_dcoeff_av_new: failed to create array from the 6th argument `dedc`";
    capi_dedc_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,dedc_Dims,dedc_Rank,  capi_dedc_intent,dedc_capi,capi_errmess);
    if (capi_dedc_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = SCHAModules_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        dedc = (double *)(PyArray_DATA(capi_dedc_as_array));
...
/*cleanupfrompyobj*/
    if((PyObject *)capi_dedc_as_array!=dedc_capi) {
        Py_XDECREF(capi_dedc_as_array); }
    }  /* if (capi_dedc_as_array == NULL) ... else of dedc */
    ...
    if((PyObject *)capi_df_as_array!=df_capi) {
        Py_XDECREF(capi_df_as_array); }
    }  /* if (capi_df_as_array == NULL) ... else of df */
...
static FortranDataDef f2py_stochastic_def[] = {
  {"average_1d",0,{{-1}},NPY_FLOAT, 1},
  {"average_3d",0,{{-1}},NPY_FLOAT, 1},
  {"standard_deviation_1d",0,{{-1}},NPY_FLOAT, 1},
  {"random_gaussian",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_stochastic_random_gaussian,doc_f2py_rout_SCHAModules_stochastic_random_gaussian},
  {"check_gaussian",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_stochastic_check_gaussian,doc_f2py_rout_SCHAModules_stochastic_check_gaussian},
  {"get_gaussian_weight",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_stochastic_get_gaussian_weight,doc_f2py_rout_SCHAModules_stochastic_get_gaussian_weight},
  {"get_gaussian_weight_eff_charge",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_stochastic_get_gaussian_weight_eff_charge,doc_f2py_rout_SCHAModules_stochastic_get_gaussian_weight_eff_charge},
  {"average_error_weight",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_stochastic_average_error_weight,doc_f2py_rout_SCHAModules_stochastic_average_error_weight},
  {"random_sphere",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_stochastic_random_sphere,doc_f2py_rout_SCHAModules_stochastic_random_sphere},
  {NULL}
};
...
static FortranDataDef f2py_thermodynamic_def[] = {
  {"w_to_a",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_thermodynamic_w_to_a,doc_f2py_rout_SCHAModules_thermodynamic_w_to_a},
  {"w_to_da",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_thermodynamic_w_to_da,doc_f2py_rout_SCHAModules_thermodynamic_w_to_da},
  {"dw_f0_u0",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_thermodynamic_dw_f0_u0,doc_f2py_rout_SCHAModules_thermodynamic_dw_f0_u0},
  {"nb",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_thermodynamic_nb,doc_f2py_rout_SCHAModules_thermodynamic_nb},
  {NULL}
};
...
static FortranDataDef f2py_anharmonic_def[] = {
  {"get_df_da_nonav",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_anharmonic_get_df_da_nonav,doc_f2py_rout_SCHAModules_anharmonic_get_df_da_nonav},
  {"get_da_dcr_and_de_dcr",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_anharmonic_get_da_dcr_and_de_dcr,doc_f2py_rout_SCHAModules_anharmonic_get_da_dcr_and_de_dcr},
  {"get_df_dcoeff_av_new",-1,{{-1}},0,0,NULL,(void *)f2py_rout_SCHAModules_anharmonic_get_df_dcoeff_av_new,doc_f2py_rout_SCHAModules_anharmonic_get_df_dcoeff_av_new},
  {NULL}
};
...
static FortranDataDef f2py_routine_defs[] = {
    {"get_stress_tensor",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_stress_tensor,GET_STRESS_TENSOR),  (f2py_init_func)f2py_rout_SCHAModules_get_stress_tensor,doc_f2py_rout_SCHAModules_get_stress_tensor},
    {"get_gradient_supercell",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_gradient_supercell,GET_GRADIENT_SUPERCELL),  (f2py_init_func)f2py_rout_SCHAModules_get_gradient_supercell,doc_f2py_rout_SCHAModules_get_gradient_supercell},
    {"get_gradient_supercell_new",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_gradient_supercell_new,GET_GRADIENT_SUPERCELL_NEW),  (f2py_init_func)f2py_rout_SCHAModules_get_gradient_supercell_new,doc_f2py_rout_SCHAModules_get_gradient_supercell_new},
    {"get_upsilon_matrix",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_upsilon_matrix,GET_UPSILON_MATRIX),  (f2py_init_func)f2py_rout_SCHAModules_get_upsilon_matrix,doc_f2py_rout_SCHAModules_get_upsilon_matrix},
    {"get_fmunu",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_fmunu,GET_FMUNU),  (f2py_init_func)f2py_rout_SCHAModules_get_fmunu,doc_f2py_rout_SCHAModules_get_fmunu},
    {"multiply_lambda_tensor",-1,{{-1}},0,0,(char *)  F_FUNC_US(multiply_lambda_tensor,MULTIPLY_LAMBDA_TENSOR),  (f2py_init_func)f2py_rout_SCHAModules_multiply_lambda_tensor,doc_f2py_rout_SCHAModules_multiply_lambda_tensor},
    {"cell_force",-1,{{-1}},0,0,(char *)  F_FUNC_US(cell_force,CELL_FORCE),  (f2py_init_func)f2py_rout_SCHAModules_cell_force,doc_f2py_rout_SCHAModules_cell_force},
    {"get_gradient_supercell_fast",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_gradient_supercell_fast,GET_GRADIENT_SUPERCELL_FAST),  (f2py_init_func)f2py_rout_SCHAModules_get_gradient_supercell_fast,doc_f2py_rout_SCHAModules_get_gradient_supercell_fast},
    {"get_unpreconditioned_gradient",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_unpreconditioned_gradient,GET_UNPRECONDITIONED_GRADIENT),  (f2py_init_func)f2py_rout_SCHAModules_get_unpreconditioned_gradient,doc_f2py_rout_SCHAModules_get_unpreconditioned_gradient},
    {"get_ymu",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_ymu,GET_YMU),  (f2py_init_func)f2py_rout_SCHAModules_get_ymu,doc_f2py_rout_SCHAModules_get_ymu},
    {"get_g",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_g,GET_G),  (f2py_init_func)f2py_rout_SCHAModules_get_g,doc_f2py_rout_SCHAModules_get_g},
    {"get_emat",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_emat,GET_EMAT),  (f2py_init_func)f2py_rout_SCHAModules_get_emat,doc_f2py_rout_SCHAModules_get_emat},
    {"get_v3",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_v3,GET_V3),  (f2py_init_func)f2py_rout_SCHAModules_get_v3,doc_f2py_rout_SCHAModules_get_v3},
    {"get_odd_straight",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_odd_straight,GET_ODD_STRAIGHT),  (f2py_init_func)f2py_rout_SCHAModules_get_odd_straight,doc_f2py_rout_SCHAModules_get_odd_straight},
    {"get_cmat",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_cmat,GET_CMAT),  (f2py_init_func)f2py_rout_SCHAModules_get_cmat,doc_f2py_rout_SCHAModules_get_cmat},
    {"get_v4",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_v4,GET_V4),  (f2py_init_func)f2py_rout_SCHAModules_get_v4,doc_f2py_rout_SCHAModules_get_v4},
    {"get_odd_straight_with_v4",-1,{{-1}},0,0,(char *)  F_FUNC_US(get_odd_straight_with_v4,GET_ODD_STRAIGHT_WITH_V4),  (f2py_init_func)f2py_rout_SCHAModules_get_odd_straight_with_v4,doc_f2py_rout_SCHAModules_get_odd_straight_with_v4},
...
PyMODINIT_FUNC PyInit_SCHAModules(void) {
    ...
    s = PyUnicode_FromString(
        "This module 'SCHAModules' is auto-generated with f2py (version:2.1.1).\nFunctions:\n"
